...
const faqData = [
  ...
  { q: "Apakah ada fitur pengingat belajar harian?", a: "Ya, kamu bisa mengaktifkan notifikasi pengingat dari menu Pengaturan Akun. Atur waktu and frekuensi pengingat sesuai jadwal belajarmu." },
];
...
function MobileNavbar({ activePage, onNavigate }) {
  const [open, setOpen] = useState(false);

  const menus = [
    { key: "dashboard", label: "Dashboard" },
    { key: "pusat-belajar", label: "Pusat Belajar" },
    { key: "bantuan", label: "Bantuan" },
  ];

  return (
    <header className="mobile-header">
      <nav className="mobile-navbar-inner">
...
function TabletNavbar({ activePage, onNavigate }) {
  return (
    <div className="tablet-navbar">
      <div className="tablet-navbar-inner">
        ...
        <div className="tablet-links">
          ...
          <button
            className={activePage === "pusat-belajar" ? "active" : ""}
            onClick={() => onNavigate("pusat-belajar")}
          >
            Pusat Belajar
          </button>

          <button
            className={activePage === "bantuan" ? "active" : ""}
